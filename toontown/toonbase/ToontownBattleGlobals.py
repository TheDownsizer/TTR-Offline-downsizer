...
AvPropDamage = ((((8 * 7, 10 * 7), (Levels[0][0], Levels[0][1])),
  ((15 * 7, 18 * 7), (Levels[0][1], Levels[0][2])),
  ((25 * 7, 30 * 7), (Levels[0][2], Levels[0][3])),
  ((40 * 7, 45 * 7), (Levels[0][3], Levels[0][4])),
  ((50 * 7, 60 * 7), (Levels[0][4], Levels[0][5])),
  ((75 * 7, 105 * 7), (Levels[0][5], Levels[0][6])),
  ((210 * 7, 210 * 7), (Levels[0][6], MaxSkill))),
 (((10 * 7, 12 * 7), (Levels[1][0], Levels[1][1])),
  ((18 * 7, 20 * 7), (Levels[1][1], Levels[1][2])),
  ((30 * 7, 35 * 7), (Levels[1][2], Levels[1][3])),
  ((50 * 7, 72 * 7), (Levels[1][3], Levels[1][4])),
  ((80 * 7, 90 * 7), (Levels[1][4], Levels[1][5])),
  ((110 * 7, 196 * 7), (Levels[1][5], Levels[1][6])),
  ((224 * 7, 224 * 7), (Levels[1][6], MaxSkill))),
 (((2, 2), (0, 0)),
  ((2, 2), (0, 0)),
  ((3, 3), (0, 0)),
  ((3, 3), (0, 0)),
  ...
  ((4, 4), (0, 0)),
  ((8, 8), (0, 0))),
 (((3 * 7, 4 * 7), (Levels[3][0], Levels[3][1])),
  ((5 * 7, 7 * 7), (Levels[3][1], Levels[3][2])),
  ((9 * 7, 12 * 7), (Levels[3][2], Levels[3][3])),
  ((16 * 7, 18 * 7), (Levels[3][3], Levels[3][4])),
  ((21 * 7, 25 * 7), (Levels[3][4], Levels[3][5])),
  ((30 * 7, 56 * 7), (Levels[3][5], Levels[3][6])),
  ((90 * 7, 90 * 7), (Levels[3][6], MaxSkill))),
 (((4 * 7, 6 * 7), (Levels[4][0], Levels[4][1])),
  ((8 * 7, 10 * 7), (Levels[4][1], Levels[4][2])),
  ((14 * 7, 17 * 7), (Levels[4][2], Levels[4][3])),
  ((24 * 7, 30 * 7), (Levels[4][3], Levels[4][4])),
  ((40 * 7, 50 * 7), (Levels[4][4], Levels[4][5])),
  ((75 * 7, 110 * 7), (Levels[4][5], Levels[4][6])),
  ((132 * 7, 132 * 7), (Levels[4][6], MaxSkill))),
 (((3 * 7, 4 * 7), (Levels[5][0], Levels[5][1])),
  ((6 * 7, 8 * 7), (Levels[5][1], Levels[5][2])),
  ((10 * 7, 12 * 7), (Levels[5][2], Levels[5][3])),
  ((18 * 7, 22 * 7), (Levels[5][3], Levels[5][4])),
  ((30 * 7, 40 * 7), (Levels[5][4], Levels[5][5])),
  ((60 * 7, 82 * 7), (Levels[5][5], Levels[5][6])),
  ((110 * 7, 110 * 7), (Levels[5][6], MaxSkill))),
 (((10 * 7, 10 * 7), (Levels[6][0], Levels[6][1])),
  ((18 * 7, 18 * 7), (Levels[6][1], Levels[6][2])),
  ((30 * 7, 40 * 7), (Levels[6][2], Levels[6][3])),
  ((45 * 7, 60 * 7), (Levels[6][3], Levels[6][4])),
  ((75 * 7, 90 * 7), (Levels[6][4], Levels[6][5])),
  ((160 * 7, 196 * 7), (Levels[6][5], Levels[6][6])),
  ((230 * 7, 230 * 7), (Levels[6][6], MaxSkill))))
ATK_SINGLE_TARGET = 0
ATK_GROUP_TARGET = 1
