...
AvPropDamage = ((((8, 10), (Levels[0][0], Levels[0][1])),
 ...
 (((10, 12), (Levels[1][0], Levels[1][1])),
  ...
  ((50, 72), (Levels[1][3], Levels[1][4])),
  ((80, 90), (Levels[1][4], Levels[1][5])),
  ((110, 196), (Levels[1][5], Levels[1][6])),
  ((224, 224), (Levels[1][6], MaxSkill))),
 (((2, 2), (0, 0)),
  ((2, 2), (0, 0)),
  ((3, 3), (0, 0)),
  ((3, 3), (0, 0)),
 ...
 (((3, 4), (Levels[3][0], Levels[3][1])),
  ...
  ((16, 18), (Levels[3][3], Levels[3][4])),
  ((21, 25), (Levels[3][4], Levels[3][5])),
  ((30, 56), (Levels[3][5], Levels[3][6])),
  ((90, 90), (Levels[3][6], MaxSkill))),
 (((4, 6), (Levels[4][0], Levels[4][1])),
  ((8, 10), (Levels[4][1], Levels[4][2])),
  ((14, 17), (Levels[4][2], Levels[4][3])),
  ((24, 30), (Levels[4][3], Levels[4][4])),
  ((40, 50), (Levels[4][4], Levels[4][5])),
  ((75, 110), (Levels[4][5], Levels[4][6])),
  ((130, 130), (Levels[4][6], MaxSkill))),
 (((3, 4), (Levels[5][0], Levels[5][1])),
  ((6, 8), (Levels[5][1], Levels[5][2])),
  ((10, 12), (Levels[5][2], Levels[5][3])),
  ((18, 22), (Levels[5][3], Levels[5][4])),
  ((30, 40), (Levels[5][4], Levels[5][5])),
  ((60, 82), (Levels[5][5], Levels[5][6])),
  ((110, 110), (Levels[5][6], MaxSkill))),
 (((10, 10), (Levels[6][0], Levels[6][1])),
  ((18, 18), (Levels[6][1], Levels[6][2])),
  ((30, 40), (Levels[6][2], Levels[6][3])),
  ((45, 60), (Levels[6][3], Levels[6][4])),
  ((75, 90), (Levels[6][4], Levels[6][5])),
  ((160, 196), (Levels[6][5], Levels[6][6])),
  ((230, 230), (Levels[6][6], MaxSkill))))
ATK_SINGLE_TARGET = 0
ATK_GROUP_TARGET = 1
