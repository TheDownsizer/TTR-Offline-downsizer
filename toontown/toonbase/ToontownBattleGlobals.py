...
AvPropAccuracy = (
  (95, 95, 95, 95, 95, 95, 100),
  (0, 0, 0, 0, 0, 0, 0),
  (50, 50, 70, 70, 80, 80, 90),
...
AvPropDamage = ((((8  * 10, 10  * 10), (Levels[0][0], Levels[0][1])),
  ((15  * 10, 18  * 10), (Levels[0][1], Levels[0][2])),
  ((25  * 10, 30  * 10), (Levels[0][2], Levels[0][3])),
  ((40  * 10, 45  * 10), (Levels[0][3], Levels[0][4])),
  ((50  * 10, 60  * 10), (Levels[0][4], Levels[0][5])),
  ((75  * 10, 105  * 10), (Levels[0][5], Levels[0][6])),
  ((210  * 10, 210  * 10), (Levels[0][6], MaxSkill))),
 (((10  * 10, 12  * 10), (Levels[1][0], Levels[1][1])),
  ((18  * 10, 20  * 10), (Levels[1][1], Levels[1][2])),
  ((30  * 10, 35  * 10), (Levels[1][2], Levels[1][3])),
  ((50  * 10, 72  * 10), (Levels[1][3], Levels[1][4])),
  ((80  * 10, 90  * 10), (Levels[1][4], Levels[1][5])),
  ((110  * 10, 196  * 10), (Levels[1][5], Levels[1][6])),
  ((224  * 10, 224  * 10), (Levels[1][6], MaxSkill))),
 (((2, 2), (0, 0)),
  ((2, 2), (0, 0)),
  ((3, 3), (0, 0)),
  ((3, 3), (0, 0)),
  ...
  ((4, 4), (0, 0)),
  ((8, 8), (0, 0))),
 (((3  * 10, 4  * 10), (Levels[3][0], Levels[3][1])),
  ((5  * 10, 7  * 10), (Levels[3][1], Levels[3][2])),
  ((9  * 10, 12  * 10), (Levels[3][2], Levels[3][3])),
  ((16  * 10, 18  * 10), (Levels[3][3], Levels[3][4])),
  ((21  * 10, 25  * 10), (Levels[3][4], Levels[3][5])),
  ((30  * 10, 56  * 10), (Levels[3][5], Levels[3][6])),
  ((90  * 10, 90  * 10), (Levels[3][6], MaxSkill))),
 (((4  * 10, 6  * 10), (Levels[4][0], Levels[4][1])),
  ((8  * 10, 10  * 10), (Levels[4][1], Levels[4][2])),
  ((14  * 10, 17  * 10), (Levels[4][2], Levels[4][3])),
  ((24  * 10, 30  * 10), (Levels[4][3], Levels[4][4])),
  ((40  * 10, 50  * 10), (Levels[4][4], Levels[4][5])),
  ((75  * 10, 110  * 10), (Levels[4][5], Levels[4][6])),
  ((132  * 10, 132  * 10), (Levels[4][6], MaxSkill))),
 (((3  * 10, 4  * 10), (Levels[5][0], Levels[5][1])),
  ((6  * 10, 8  * 10), (Levels[5][1], Levels[5][2])),
  ((10  * 10, 12  * 10), (Levels[5][2], Levels[5][3])),
  ((18  * 10, 22  * 10), (Levels[5][3], Levels[5][4])),
  ((30  * 10, 40  * 10), (Levels[5][4], Levels[5][5])),
  ((60  * 10, 82  * 10), (Levels[5][5], Levels[5][6])),
  ((110  * 10, 110  * 10), (Levels[5][6], MaxSkill))),
 (((10  * 10, 10  * 10), (Levels[6][0], Levels[6][1])),
  ((18  * 10, 18  * 10), (Levels[6][1], Levels[6][2])),
  ((30  * 10, 40  * 10), (Levels[6][2], Levels[6][3])),
  ((45  * 10, 60  * 10), (Levels[6][3], Levels[6][4])),
  ((75  * 10, 90  * 10), (Levels[6][4], Levels[6][5])),
  ((160  * 10, 196  * 10), (Levels[6][5], Levels[6][6])),
  ((230  * 10, 230  * 10), (Levels[6][6], MaxSkill))))
ATK_SINGLE_TARGET = 0
ATK_GROUP_TARGET = 1
