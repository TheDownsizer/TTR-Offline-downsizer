...
class FindPackageQuest(LocationBasedQuest):
    def __init__(self, id, quest):
        LocationBasedQuest.__init__(self, id, quest)
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            return TTLocalizer.QuestsTreasureQuestProgressString % {'progress': questDesc[4],
    ...
    def getString(self):
        return TTLocalizer.QuestsTreasureQuestString % self.getObjectiveStrings()[0]
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        if count == 1:
            ...
            text = TTLocalizer.QuestsTreasureQuestDescI
        objective = text
        location = self.getLocationName()
        return TTLocalizer.QuestsTreasureQuestSCString % {'objective': objective,
         'location': location}

    def getHeadlineString(self):
        return TTLocalizer.QuestsTreasureQuestHeadline
...
QuestDict = {
 ...
 1065: (TT_TIER + 2,
        Cont,
        (FindPackageQuest, ToontownGlobals.LoopyLane, 1, 2206, "Silli-Scope"),
        2215,
        2215,
        101,
        1066,
 ...
 7266: (DL_TIER + 1,
        Start,
        (SupervisorQuest, ToontownGlobals.CashbotMintIntB, 2),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 7267: (DL_TIER + 1,
        OBSOLETE,
        (SupervisorQuest, ToontownGlobals.CashbotMintIntC, 1),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8211: (DL_TIER + 2,
        Start,
        (MintQuest, ToontownGlobals.CashbotMintIntB, 2),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8213: (DL_TIER + 2,
        Start,
        (SkelecogQuest, ToontownGlobals.CashbotMintIntA, 5),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8214: (DL_TIER + 2,
        Start,
        (SkelecogQuest, ToontownGlobals.CashbotMintIntB, 4),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8215: (DL_TIER + 2,
        Start,
        (SkelecogQuest, ToontownGlobals.CashbotMintIntC, 3),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9213: (DL_TIER + 3,
        Start,
        (SkelecogQuest, ToontownGlobals.CashbotMintIntA, 3),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9214: (DL_TIER + 3,
        Start,
        (SkelecogQuest, ToontownGlobals.CashbotMintIntB, 3),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9216: (DL_TIER + 3,
        Start,
        (SupervisorQuest, ToontownGlobals.CashbotMintIntA, 2),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9218: (DL_TIER + 3,
        Start,
        (SupervisorQuest, ToontownGlobals.CashbotMintIntC, 2),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 10141: (ELDER_TIER,
         Start,
         (MintQuest, ToontownGlobals.CashbotHQ, 4),
         Any,
         ToonHQ,
         Any,
         NA,
 ...
 10142: (ELDER_TIER,
         Start,
         (SupervisorQuest, ToontownGlobals.CashbotHQ, 4),
         Any,
         ToonHQ,
         Any,
         NA,
 ...
 10207: (ELDER_TIER,
         ...
         NA,
         DefaultDialog),
 11000: (LAWBOT_HQ_TIER, Start, (VisitQuest,), Any, 3310, NA, 11001, DefaultDialog),
 11001: (LAWBOT_HQ_TIER, Cont, (RecoverItemQuest, ToontownGlobals.LawbotHQ, 1, 3027, Hard, Any), Same, Same, 4100, NA, TTLocalizer.QuestDialogDict[11001]),
