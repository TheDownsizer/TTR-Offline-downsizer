...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def loadEnvironment(self):
        ...
        self.midVault = loader.loadModel('phase_10/models/cashbotHQ/ttr_m_ara_chq_bossMidVault')
        self.endVault = loader.loadModel('phase_10/models/cashbotHQ/ttr_m_ara_chq_bossEndVault')
        self.lightning = loader.loadModel('phase_10/models/cogHQ/ttr_m_ara_chq_craneLightning')
        self.magnet = loader.loadModel('phase_10/models/cogHQ/ttr_m_ara_chq_craneMagnet')
        self.craneArm = loader.loadModel('phase_10/models/cogHQ/ttr_m_ara_chq_craneArm')
        self.controls = loader.loadModel('phase_10/models/cogHQ/ttr_m_ara_chq_craneControls')
        self.stick = loader.loadModel('phase_10/models/cogHQ/ttr_m_ara_chq_craneStick')
        self.safe = loader.loadModel('phase_10/models/cogHQ/ttr_m_ara_chq_cashSafe')
