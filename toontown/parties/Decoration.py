...
class Decoration(NodePath):
    ...
    def __init__(self, name, x, y, h):
        ...
        if self.name == 'CakeTower':
            ...
            self.partyBanner.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
            ...
            self.partyGlobe.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
            ...
            self.flyingHeart.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
            ...
            self.heartBanner.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
            ...
            slef.bannerVictory.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
            ...
            balloonLeft.reparentTo(balloonLeftLocator)
            balloonRight.reparentTo(balloonRightLocator)
            self.bannerVictory.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
