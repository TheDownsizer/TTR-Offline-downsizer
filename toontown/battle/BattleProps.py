...
Props = ((5, 'partyBall', 'partyBall'), 
 ...
 (5,
  'birthday-cake',
  'ttr_r_prp_bat_birthdayCake',
  'ttr_a_prp_bat_birthdayCake_birthdayThrow'),
 ...
 (5,
  ...
  'smile-mod',
  'smile-chan'),
 (3.5, 'ttr_m_ene_prp_bat_golfClub', 'ttr_m_ene_prp_bat_golfClub'),
 ...
 (5, 'ttr_m_prp_bat_dagger', 'ttr_m_prp_bat_dagger'),
 (5, 'card', 'card'),
 (5, 'baseball', 'baseball'),
 (5, 'bird', 'bird'),
 (5, 'can', 'can'),
 ...
 (4, 'ttr_m_efx_gen_ripples', 'ttr_m_efx_gen_ripples'),
 (4, 'wake', 'wake'),
 (4,
  'splashdown',
  'SZ_splashdown-mod',
